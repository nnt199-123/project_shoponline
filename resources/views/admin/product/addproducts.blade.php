...
<div class="">
          <div class="card card-primary">
            ...
            <form action="{{URL::to('admin/product/addsp')}}" method="POST" >
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label for="inputName">Tên sản phẩm</label>
                        <input type="text" id="inputName" name="ten" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="inputDescription">Giá</label>
                        <textarea id="inputDescription" name="gia" class="form-control" rows="1"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="inputDescription"  >Giá khuyến mãi</label>
                        <textarea id="inputDescription" name="giakm" class="form-control" rows="1"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="hing" id="inputClientCompany" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="inputClientCompany">Lượt xem</label>
                        <input type="number" name="xem" id="inputClientCompany" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="ngay" id="inputClientCompany" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="inputProjectLeader">Màu sắc</label>
                        <input type="text" name="mausac" id="inputProjectLeader" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="inputProjectLeader">Cân nặng</label>
                        <input type="text" name="cannang" id="inputProjectLeader" class="form-control">
                    </div>
                    <input type="submit" value="Thêm vào danh sách sản phẩm" class="btn btn-success">
                </div>
            </form>
